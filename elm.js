...
var _user$project$Spinner$initialModel = {value: 1};
		...
		},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$points('10,20 -10,20 0,-20 10,20'),
						_1: {
							ctor: '::',
...
var _user$project$Spinner$Model = function (a) {
	return {value: a};
};
var _user$project$Spinner$Msg = {};

var Elm = {};
Elm['Spinner'] = Elm['Spinner'] || {};
if (typeof _user$project$Spinner$main !== 'undefined') {
    _user$project$Spinner$main(Elm['Spinner'], 'Spinner', undefined);
}
